...
// submits a given form using a JSON POST request
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById("reset-password")) { document.getElementById("reset-password").addEventListener('submit', async(event) => { await onAuthFormSubmit(event, "/reset_password"); }); }
});